export default {
  ...
  "geo_site.invalid_lookup_domain": "Invalid GeoSite lookup domain: {0}",
  ...
  "geo_ip.source_request_failed": "GeoIP source request failed: {0}",
  "geo_ip.config_store_failed": "Failed to save GeoIP config: {0}",
  "geo_ip.dat_decode_error": "GeoIP DAT file decode error",
  "geo_ip.no_valid_cidr": "GeoIP TXT file contains no valid CIDR entries",
  "geo_ip.invalid_lookup_address": "Invalid GeoIP lookup address: {0}",
