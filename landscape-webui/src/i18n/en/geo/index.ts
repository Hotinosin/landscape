export default {
  ...
  geo_site: {
    ...
    lookup_confirm_title: "Domain Format Notice",
    lookup_confirm_content: "GeoSite lookup requires a full domain name (e.g. {example}). Do you want to query {suggested}?",
    lookup_confirm_positive: "Query {domain}",
