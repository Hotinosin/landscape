export default {
  ...
  upstream_edit: {
    ...
    test_h3: "测试 H3",
    h3_test_title: "DoH3 连接测试",
    h3_test_success: "H3 连接成功并返回 DNS 结果",
    h3_test_partial: "H3 连接不稳定，仅部分查询成功",
    h3_test_failed: "H3 连接失败，请查看下方每次请求的错误信息",
    h3_test_timeout: "H3 连接超时，请检查网络是否允许 UDP/443",
    h3_test_network_unreachable: "网络不可达，请检查默认路由和出口配置",
    h3_test_tls_failed: "H3 TLS 握手失败，请检查域名、证书和系统时间",
    h3_test_request_failed: "测试接口请求失败，请检查后端服务或稍后重试",
    test_domain: "测试域名",
    reuse_average: "复用请求平均延迟",
    connection_count: "H3 建连次数",
    connection: "连接",
    connection_new: "新建",
